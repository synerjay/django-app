...
SECRET_KEY = 'django-insecure-4wb4*3)l&d9_n=0013(6*jv!^__1ex7nw2@mof_$us^_fj_&q7'
...
INSTALLED_APPS = [
    ...
    'articles',
    'accounts', # when you make a new django app, you MUST add it here in the installed apps
]
